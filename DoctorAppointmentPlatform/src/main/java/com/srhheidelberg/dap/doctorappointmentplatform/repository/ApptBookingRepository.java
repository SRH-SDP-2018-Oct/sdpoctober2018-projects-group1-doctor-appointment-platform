...
public interface ApptBookingRepository extends JpaRepository<AppointmentBooking, Integer> {
	...
	@Query("SELECT appbo FROM AppointmentBooking appbo WHERE appbo.appointmentBookingSlotDay = :appointmentBookingSlotDay AND appbo.appointmentBookingSlotTime = :appointmentBookingSlotTime AND"
			+ " appbo.appointmentBookingDoctorCity = :appointmentBookingDoctorCity AND appbo.appointmentBookingDoctorType = :appointmentBookingDoctorType")
